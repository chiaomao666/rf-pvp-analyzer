...
import { Check, ClipboardPenLine, Upload } from "lucide-react";
...
export default function Record() {
  ...
  return <div className="page-enter">
    <section className="page-titlebar compact-titlebar"><div><p className="eyebrow">MANUAL ENTRY / 5V5 RANKED BATTLE</p><h1>新增對戰<span className="title-underscore">_</span></h1><p>{profile ? "此紀錄只會儲存於目前帳號工作區。" : "請先選取帳號工作區；尚未選取時不能保存戰績。"}</p></div><div className="button-cluster"><Link href="/account"><Button variant="outline" className="blueprint-button secondary-button">帳號工作區</Button></Link><Link href="/import"><Button variant="outline" className="blueprint-button secondary-button"><Upload size={16} />改用 JSON 匯入</Button></Link></div></section>
