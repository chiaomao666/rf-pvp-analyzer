...
export default function Account() {
  ...
  const onSiteLogout = async () => { await logoutRemoteSite(); setSitePassword(""); setSiteAdminPassword(""); setCurrentSitePassword(""); setNewSitePassword(""); setConfirmSitePassword(""); setSiteSessionActive(false); setBridgeStatus("offline"); setStatus({ tone: "info", text: "已登出網站後端；本機戰績與工作區未刪除。" }); };
